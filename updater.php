...
class MY_Plugin_Updater{
	...
	public function modify_transient( $transient ) {
		...
		if( property_exists( $transient, 'checked') ) { // Check if transient has a checked property
			...
			if( $checked = $transient->checked ) { // Did Wordpress check for updates?				
				...
				if(!empty($this->github_response) && isset($this->github_response['tag_name']) && $this->github_response['zipball_url']){
	...
	public function plugin_popup( $result, $action, $args ) {
		...
		if( ! empty( $args->slug ) ) { // If there is a slug
			...
			if( $args->slug == current( explode( '/' , $this->basename ) ) ) { // And it's our slug
				...
				if(isset($this->github_response['tag_name']) && isset($this->github_response['published_at']) && isset($this->github_response['body']) && isset($this->github_response['zipball_url'])){
	...
	public function download_package( $args, $url ) {
		...
		if(isset($_POST) && isset($_POST['action']) && $_POST['action'] == 'update-plugin' && $_POST['plugin'] == 'git-update/git-update.php'){
